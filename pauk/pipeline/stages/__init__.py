...
# unclassified (is_relevant=None) links it judges. github_match needs the
# accounts repositories harvests and the authorships dedup has already
# folded, so it follows both.
ALL_STAGES = (
    PdfStage, PersonsStage, DepartmentsStage, CodeLinksStage, LinkRelevanceStage,
    RepositoriesStage, DedupStage, GitHubMatchStage, RussianNamesStage,
)