...
норвежский RITMO становится нашим), `saint petersburg`, `sankt`. Форму
`St. Petersburg` он не ловит; на текущих данных это семь аккаунтов, ни
один матч от этого не меняется, поэтому регекс оставлен как есть.
