...
## Что не ловит точное совпадение

Совпадение DOI/заголовка выше — точное: две записи одной работы с разными
DOI **и** отредактированным заголовком (препринт с полированным для
журнала заголовком, перевод на другой язык, ревизия под собственным DOI)
остаются раздельными публикациями. Эвристический поиск таких пар —
отдельный, только докладывающий инструмент, см.
[version-candidates.md](version-candidates.md).
