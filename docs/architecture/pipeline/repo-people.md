...
никогда. Профили, сохранённые до появления признака, считаются полученными
по содержимому — заготовка владельца не несёт ни имени, ни локации, ни
компании, ни почт. Аккаунт,
