...
- Публикация только добавляет. Строка, удалённая из Mongo, остаётся в графе
  до ручной чистки ([#145](https://github.com/ITMO-NSS-team/PAUK/issues/145),
  обход — `scripts/prune_graph_to_mongo.py`).
