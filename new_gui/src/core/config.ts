...
export const MAP_CONFIG = {
  ...
  node: {
    ...
    // Цвет узла, который НЕ сосед наведённого/выбранного (см.
    // applyHighlighting в map/build.ts) — приглушённый нейтральный серый,
    // отличимый от ярких department-цветов, но не сливающийся с фоном.
    dimColor: "#4a4a4a",
  ...
  edge: {
    ...
    // Ребро, не задевающее наведённый/выбранный узел — почти прозрачное, а
    // не полностью скрытое (hidden: true): структура связей должна
    // угадываться, а не резко исчезать, как в Obsidian graph view.
    colorDimmed: "rgba(157, 157, 157, 0.06)",
    width: 0.6,
    widthSelected: 2,
  },
} as const;
