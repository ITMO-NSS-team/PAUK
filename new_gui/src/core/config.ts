...
export const FILTER_CONFIG = {
  ...
  // регулятором по прямой просьбе. step дробный (не 1, как у остальных
  // регуляторов) — camera.ratio сам по себе дробное число в диапазоне
  // примерно 0.05 (сильное приближение) — 1.5 (весь граф целиком), а не
  // счётная величина вроде "число публикаций". default — прежнее
  // захардкоженное значение, ничего не меняется до первого движения ползунка.
  edgeZoom: { min: 0.05, max: 1, step: 0.05, default: 0.4 },
