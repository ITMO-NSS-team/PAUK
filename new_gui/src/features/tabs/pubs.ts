 ...
 * приходит из `pubDetails` (`core/data.ts::loadSamplePubDetails()`,
 * синтетический аналог `graph-search.js`), {@link nodeLabel} откатится на
 * ключ публикации, только если для неё нет записи в `pubDetails`.
 *
